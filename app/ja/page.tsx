...
export default function Home() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch("/api/ai-generate/ja", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          wordText: wordInput,
            ...
            <section className="relative pt-24 pb-12 px-6 flex flex-col items-center text-center">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 z-10 relative">
                ...
                {process.env.NODE_ENV === 'development' && (
                  <button
                    ...
                    className="mt-4 text-xs font-mono text-neutral-400 hover:text-indigo-500 underline"
                  >
                    [DEV] Click here to skip login check
                  </button>
                )}
              </div>
              ...
              <div className="mt-32 relative w-full max-w-4xl mx-auto h-[400px] select-none pointer-events-none hidden sm:block">
                ...
                <div className="absolute top-10 left-0 xl:-left-12 w-64 p-6 bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 rotate-[-6deg] animate-in slide-in-from-left-12 duration-1000 delay-300">
                  ...
                  <div className="text-3xl font-black mb-2 font-serif">運命</div>
                  <div className="text-sm text-neutral-500">【名】Serendipity</div>
                </div>
                {/* Card 2: Center (Front) */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-72 p-8 bg-indigo-600 text-white rounded-3xl shadow-2xl shadow-indigo-500/30 rotate-[0deg] z-10 animate-in zoom-in duration-700 delay-500">
                  ...
                  <div className="text-4xl font-black mb-4 font-serif">儚い</div>
                  <div className="text-indigo-200 text-sm font-bold">【形】Ephemeral, Fleeting</div>
                ...
                <div className="absolute top-20 right-0 xl:-right-12 w-60 p-6 bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 rotate-[6deg] animate-in slide-in-from-right-12 duration-1000 delay-700">
                  ...
                  <div className="text-2xl font-black mb-2 font-serif">平穏</div>
                </div>
              </div>
            </section>
                    ...
                    <div className="bg-white dark:bg-neutral-900 p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                      <div className="mb-6">
                        <label className="block text-xs font-bold text-neutral-400 uppercase tracking-wider mb-2">
                          単語を入力 <span className="text-neutral-500 font-normal ml-1 text-[10px]">(りんご, 走る など)</span>
                        </label>
                        <textarea
                      ...
                      <div className="mb-6">
                        <label className="block text-xs font-bold text-neutral-400 uppercase tracking-wider mb-2">
                          熟語を入力 <span className="text-neutral-500 font-normal ml-1 text-[10px]">(気にする, 手を抜く など)</span>
                        </label>
                        <textarea
