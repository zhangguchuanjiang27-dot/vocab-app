    ...
    return (
        <div className="max-w-3xl mx-auto px-6 py-24 text-neutral-900 dark:text-neutral-100">
            ...
            <div className="prose dark:prose-invert prose-neutral max-w-none text-sm sm:text-base">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第3条（個人情報を収集・利用する目的）</h3>
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第4条（利用目的の変更）</h3>
                <p>本サービスは，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。</p>

                <h3 className="text-xl font-bold mt-8 mb-4">第5条（個人情報の第三者提供）</h3>
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第6条（Cookieおよびアクセス解析ツールについて）</h3>
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第7条（プライバシーポリシーの変更）</h3>
                <p>本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</p>

                <h3 className="text-xl font-bold mt-8 mb-4">第8条（お問い合わせ窓口）</h3>
