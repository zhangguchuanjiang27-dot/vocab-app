...
export async function POST(req: Request) {
    ...
    try {
      ...
      3. **例文の網羅性**:
         - example (メイン): 最も代表的な意味を使った例文。
         - otherExamples (追加): **それ以外の重要な意味すべて**について、それぞれに対応する例文を生成してください。
         - otherExamples の role には、"名詞(資本)" のように**品詞と意味**を明記してください。
      4. **原形への変換**: 単語単体の場合は原形に直してください。
      ...
      5. example_jp: 例文の和訳
      6. otherExamples: 他の重要な意味をカバーする追加例文リスト
         - role: "名詞(資本)", "形容詞(主要な)" などの形式
         - text: 英語の例文
         - translation: 和訳
