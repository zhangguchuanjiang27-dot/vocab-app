    ...
    return (
        <div className="max-w-3xl mx-auto px-6 py-24 text-neutral-900 dark:text-neutral-100">
            ...
            <div className="prose dark:prose-invert prose-neutral max-w-none text-sm sm:text-base">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第1条（適用）</h3>
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第2条（利用登録）</h3>
                <ol className="list-decimal pl-5 space-y-2">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第3条（ユーザーIDおよびパスワードの管理）</h3>
                <ol className="list-decimal pl-5 space-y-2">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第4条（利用料金および支払方法）</h3>
                <ol className="list-decimal pl-5 space-y-2">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第5条（AI生成機能に関する特記事項）</h3>
                <ol className="list-decimal pl-5 space-y-2">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第6条（禁止事項）</h3>
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第7条（本サービスの提供の停止等）</h3>
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第8条（利用制限および登録抹消）</h3>
                <ol className="list-decimal pl-5 space-y-2">
                ...
                <h3 className="text-xl font-bold mt-8 mb-4">第9条（退会）</h3>
                <p>ユーザーは，運営者の定める退会手続により，本サービスから退会できるものとします。</p>

                <h3 className="text-xl font-bold mt-8 mb-4">第10条（保証の否認および免責事項）</h3>
                <ol className="list-decimal pl-5 space-y-2">
